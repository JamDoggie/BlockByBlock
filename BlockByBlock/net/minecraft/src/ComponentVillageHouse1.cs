...
namespace net.minecraft.src
{
	...
	public class ComponentVillageHouse1 : ComponentVillage
	{
		...
		public ComponentVillageHouse1(int i1, Random random2, StructureBoundingBox structureBoundingBox3, int i4) : base(i1)
		{
		...
		public static ComponentVillageHouse1 findValidPlacement(System.Collections.IList list0, Random random1, int i2, int i3, int i4, int i5, int i6)
		{
