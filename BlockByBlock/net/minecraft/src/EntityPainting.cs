...
namespace net.minecraft.src
{
	...
	public class EntityPainting : Entity
	{
		...
		public EntityPainting(World world1, int i2, int i3, int i4, int i5) : this(world1)
		{
			...
			{
				this.art = (EnumArt)arrayList6[this.rand.Next(arrayList6.Count)];
			}
		...
		public virtual bool onValidSurface()
		{
			...
			else
			{
				...
				System.Collections.IList list9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox);
		...
		{
			nBTTagCompound1.setByte("Dir", (sbyte)this.direction);
