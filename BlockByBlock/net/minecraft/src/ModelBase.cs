...
namespace net.minecraft.src
{
	...
	public abstract class ModelBase
	{
		...
		public System.Collections.IList boxList = new ArrayList();
		public bool isChild = true;
		private System.Collections.IDictionary modelTextureMap = new Hashtable();
		...
		{
			this.modelTextureMap[string1] = new TextureOffset(i2, i3);
		}

		public virtual TextureOffset getTextureOffset(string string1)
		{
			return (TextureOffset)this.modelTextureMap[string1];
		}
	}
