...
namespace net.minecraft.src
{
	...
	public class EntityDragon : EntityDragonBase
	{
		...
		{
			dragonPartArray = new EntityDragonPart[]{this.dragonPartHead = new EntityDragonPart(this, "head", 6.0F, 6.0F), this.dragonPartBody = new EntityDragonPart(this, "body", 8.0F, 8.0F), this.dragonPartTail1 = new EntityDragonPart(this, "tail", 4.0F, 4.0F), this.dragonPartTail2 = new EntityDragonPart(this, "tail", 4.0F, 4.0F), this.dragonPartTail3 = new EntityDragonPart(this, "tail", 4.0F, 4.0F), this.dragonPartWing1 = new EntityDragonPart(this, "wing", 4.0F, 4.0F), this.dragonPartWing2 = new EntityDragonPart(this, "wing", 4.0F, 4.0F)};
		}
		...
		{
			base.entityInit();
			this.dataWatcher.addObject(16, new int?(this.maxHealth));
		}
		...
		public override void onLivingUpdate()
		{
			...
			else
			{
				...
				else
				{
					...
					for (this.motionY += (float)(d4 * (double)0.1F); this.rotationYaw < -180.0F; this.rotationYaw += 360.0F)
					{
					}
		...
		private void updateDragonEnderCrystal()
		{
			...
			{
				float f1 = 32.0F;
				System.Collections.IList list2 = this.worldObj.getEntitiesWithinAABB(typeof(EntityEnderCrystal), this.boundingBox.expand((double)f1, (double)f1, (double)f1));
		...
		private void func_41006_aA()
		{
			...
			if (this.rand.Next(2) == 0 && this.worldObj.playerEntities.Count > 0)
			{
				this.target = (Entity)this.worldObj.playerEntities[this.rand.Next(this.worldObj.playerEntities.Count)];
			}
			else
			{
				bool z1 = false;
