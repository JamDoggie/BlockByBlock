	...
	public class RenderPlayer : RenderLiving
	{
			...
			if (Minecraft.GuiEnabled && entityPlayer1 != this.renderManager.livingPlayer)
			{
				...
				if (f10 < f11)
				{
					...
					else
					{
                        ...
                        Minecraft.newRenderer.ModelMatrix.Translate((float)d2 + 0.0F, (float)d4 + 2.3F, (float)d6);
                        ...
                        Minecraft.newRenderer.ModelMatrix.Translate(0.0F, 0.25F / f9, 0.0F);
						GL.DepthMask(false);
		...
		protected internal virtual void renderSpecials(EntityPlayer entityPlayer1, float f2)
		{
			...
			if (itemStack3 != null && itemStack3.Item.shiftedIndex < 256)
			{
				...
				{
					float f4 = 0.625F;
                    Minecraft.newRenderer.ModelMatrix.Translate(0.0F, -0.25F, 0.0F);
			...
			if (entityPlayer1.username.Equals("deadmau5") && this.loadDownloadableImageTexture(entityPlayer1.skinUrl, (string)null))
			{
				for (int i19 = 0; i19 < 2; ++i19)
				{
					...
					Minecraft.newRenderer.ModelMatrix.Translate(0.375F * (float)(i19 * 2 - 1), 0.0F, 0.0F);
					Minecraft.newRenderer.ModelMatrix.Translate(0.0F, -0.375F, 0.0F);
					Minecraft.newRenderer.ModelMatrix.Rotate(-f6, 1.0F, 0.0F, 0.0F);
                    Minecraft.newRenderer.ModelMatrix.Rotate(-f5, 0.0F, 1.0F, 0.0F);
					float f7 = 1.3333334F;
			...
			{
                Minecraft.newRenderer.ModelMatrix.PushMatrix();
                Minecraft.newRenderer.ModelMatrix.Translate(0.0F, 0.0F, 0.125F);
                ...
                Minecraft.newRenderer.ModelMatrix.Rotate(6.0F + f16 / 2.0F + f15, 1.0F, 0.0F, 0.0F);
                Minecraft.newRenderer.ModelMatrix.Rotate(f17 / 2.0F, 0.0F, 0.0F, 1.0F);
                Minecraft.newRenderer.ModelMatrix.Rotate(-f17 / 2.0F, 0.0F, 1.0F, 0.0F);
                Minecraft.newRenderer.ModelMatrix.Rotate(180.0F, 0.0F, 1.0F, 0.0F);
			...
			if (itemStack21 != null)
			{
				...
				if (itemStack21.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemStack21.itemID].RenderType))
				{
                    ...
                    Minecraft.newRenderer.ModelMatrix.Scale(f6, -f6, f6);
				}
				...
				else if (Item.itemsList[itemStack21.itemID].Full3D)
				{
					...
					if (Item.itemsList[itemStack21.itemID].shouldRotateAroundWhenRendering())
					{
                        ...
                        Minecraft.newRenderer.ModelMatrix.Translate(0.0F, -0.125F, 0.0F);
					}

					if (entityPlayer1.ItemInUseCount > 0 && enumAction22 == EnumAction.block)
					{
                        Minecraft.newRenderer.ModelMatrix.Translate(0.05F, 0.0F, -0.1F);
                        Minecraft.newRenderer.ModelMatrix.Rotate(-50.0F, 0.0F, 1.0F, 0.0F);
                        Minecraft.newRenderer.ModelMatrix.Rotate(-10.0F, 1.0F, 0.0F, 0.0F);
		...
		protected internal virtual void rotatePlayer(EntityPlayer entityPlayer1, float f2, float f3, float f4)
		{
			if (entityPlayer1.EntityAlive && entityPlayer1.PlayerSleeping)
			{
				Minecraft.newRenderer.ModelMatrix.Rotate(entityPlayer1.BedOrientationInDegrees, 0.0F, 1.0F, 0.0F);
				Minecraft.newRenderer.ModelMatrix.Rotate(this.getDeathMaxRotation(entityPlayer1), 0.0F, 0.0F, 1.0F);
                Minecraft.newRenderer.ModelMatrix.Rotate(270.0F, 0.0F, 1.0F, 0.0F);
			}
			else
			{
