...
namespace net.minecraft.src
{
	...
	public class ComponentStrongholdPrison : ComponentStronghold
	{
		...
		public ComponentStrongholdPrison(int i1, Random random2, StructureBoundingBox structureBoundingBox3, int i4) : base(i1)
		{
		...
		public static ComponentStrongholdPrison findValidPlacement(System.Collections.IList list0, Random random1, int i2, int i3, int i4, int i5, int i6)
		{
