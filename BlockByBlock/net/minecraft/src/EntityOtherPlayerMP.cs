...
namespace net.minecraft.src
{
	public class EntityOtherPlayerMP : EntityPlayer
	{
		...
		public EntityOtherPlayerMP(World world1, string string2) : base(world1)
		{
			...
			if (!string.ReferenceEquals(string2, null) && string2.Length > 0)
			{
		...
		public override void onUpdate()
		{
			...
			if (!this.isItemInUse && this.Eating && this.inventory.mainInventory[this.inventory.currentItem] != null)
			{
			...
			else if (this.isItemInUse && !this.Eating)
			{
				this.clearItemInUse();
