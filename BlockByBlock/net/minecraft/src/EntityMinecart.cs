...
namespace net.minecraft.src
{
	...
	public class EntityMinecart : Entity, IInventory
	{
		...
		{
			for (int i1 = 0; i1 < this.SizeInventory; ++i1)
			{
				...
				if (itemStack2 != null)
				{
					...
					while (itemStack2.stackSize > 0)
					{
						...
						EntityItem entityItem7 = new EntityItem(this.worldObj, this.posX + (double)f3, this.posY + (double)f4, this.posZ + (double)f5, new ItemStack(itemStack2.itemID, i6, itemStack2.ItemDamage));
		...
		public override void onUpdate()
		{
			...
			else
			{
				...
				this.setRotation(this.rotationYaw, this.rotationPitch);
				System.Collections.IList list15 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand((double)0.2F, 0.0D, (double)0.2F));
				if (list15 != null && list15.Count > 0)
				{
					for (int i50 = 0; i50 < list15.Count; ++i50)
					{
						Entity entity17 = (Entity)list15[i50];
						if (entity17 != this.riddenByEntity && entity17.canBePushed() && entity17 is EntityMinecart)
						{
		...
		protected internal override void readEntityFromNBT(NBTTagCompound nBTTagCompound1)
		{
			...
			else if (this.minecartType == 1)
			{
				...
				this.cargoItems = new ItemStack[this.SizeInventory];
		...
		public override void applyEntityCollision(Entity entity1)
		{
			if (!this.worldObj.isRemote)
			{
				...
				{
					if (entity1 is EntityLiving && !(entity1 is EntityPlayer) && !(entity1 is EntityIronGolem) && this.minecartType == 0 && this.motionX * this.motionX + this.motionZ * this.motionZ > 0.01D && this.riddenByEntity == null && entity1.ridingEntity == null)
					{
		...
		protected internal virtual bool MinecartPowered
		{
			...
			set
			{
				if (value)
				{
					this.dataWatcher.updateObject(16, (sbyte)(this.dataWatcher.getWatchableObjectByte(16) | 1));
				}
				else
				{
					this.dataWatcher.updateObject(16, (sbyte)(this.dataWatcher.getWatchableObjectByte(16) & -2));
				}
