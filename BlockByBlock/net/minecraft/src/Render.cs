namespace net.minecraft.src
{
	...
	public abstract class Render
	{
			...
			for (int i32 = i19; i32 <= i20; ++i32)
			{
				for (int i33 = i21; i33 <= i22; ++i33)
				{
					for (int i34 = i23; i34 <= i24; ++i34)
					{
						...
						{
							this.renderShadowOnBlock(Block.blocksList[i35], d2, d4 + (double)entity1.ShadowSize, d6, i32, i33, i34, f8, f12, d25, d27 + (double)entity1.ShadowSize, d29);
						}
					}
				}
			}
		...
		private void renderShadowOnBlock(Block block1, double d2, double d4, double d6, int i8, int i9, int i10, float f11, float f12, double d13, double d15, double d17)
		{
			...
			{
				double d20 = ((double)f11 - (d4 - ((double)i9 + d15)) / 2.0D) * 0.5D * (double)this.WorldFromRenderManager.getLightBrightness(i8, i9, i10);
				if (d20 >= 0.0D)
				{
					if (d20 > 1.0D)
					{
