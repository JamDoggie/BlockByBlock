...
namespace net.minecraft.src
{
	...
	public class EntityArrow : Entity
	{
		...
		public EntityArrow(World world1, EntityLiving entityLiving2, EntityLiving entityLiving3, float f4, float f5) : base(world1)
		{
			...
			this.doesArrowBelongToPlayer = entityLiving2 is EntityPlayer;
			this.posY = entityLiving2.posY + (double)entityLiving2.EyeHeight - (double)0.1F;
			double d6 = entityLiving3.posX - entityLiving2.posX;
			double d8 = entityLiving3.posY + (double)entityLiving3.EyeHeight - (double)0.7F - this.posY;
		...
		public EntityArrow(World world1, EntityLiving entityLiving2, float f3) : base(world1)
		{
			...
			this.doesArrowBelongToPlayer = entityLiving2 is EntityPlayer;
			this.setSize(0.5F, 0.5F);
			this.setLocationAndAngles(entityLiving2.posX, entityLiving2.posY + (double)entityLiving2.EyeHeight, entityLiving2.posZ, entityLiving2.rotationYaw, entityLiving2.rotationPitch);
		...
		public override void onUpdate()
		{
			...
			else
			{
				...
				Entity entity4 = null;
				System.Collections.IList list5 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0D, 1.0D, 1.0D));
				double d6 = 0.0D;
				...
				if (movingObjectPosition3 != null)
				{
					if (movingObjectPosition3.entityHit != null)
					{
						...
						int i20 = (int)Math.Ceiling((double)f19 * this.damage);
						if (this.arrowCritical)
						{
							i20 += this.rand.Next(i20 / 2 + 2);
						}
		...
		public override void writeEntityToNBT(NBTTagCompound nBTTagCompound1)
		{
			...
			nBTTagCompound1.setByte("inTile", (sbyte)this.inTile);
			nBTTagCompound1.setByte("inData", (sbyte)this.inData);
			nBTTagCompound1.setByte("shake", (sbyte)this.arrowShake);
			nBTTagCompound1.setByte("inGround", (sbyte)(this.inGround ? 1 : 0));
