...
namespace net.minecraft.src
{
	...
	public class EntitySheep : EntityAnimal
	{
		...
		protected internal override void dropFewItems(bool z1, int i2)
		{
			if (!this.Sheared)
			{
				this.entityDropItem(new ItemStack(Block.cloth.blockID, 1, this.FleeceColor), 0.0F);
			}
		...
		public override bool interact(EntityPlayer entityPlayer1)
		{
			...
			if (itemStack2 != null && itemStack2.itemID == Item.shears.shiftedIndex && !this.Sheared && !this.Child)
			{
				if (!this.worldObj.isRemote)
				{
					this.Sheared = true;
					int i3 = 1 + this.rand.Next(3);
		...
		public override void writeEntityToNBT(NBTTagCompound nBTTagCompound1)
		{
			...
			nBTTagCompound1.setByte("Color", (sbyte)this.FleeceColor);
		}
		...
		public override void readEntityFromNBT(NBTTagCompound nBTTagCompound1)
		{
			...
			this.FleeceColor = nBTTagCompound1.getByte("Color");
		}
		...
		public virtual int FleeceColor
		{
			...
			set
			{
				...
				this.dataWatcher.updateObject(16, unchecked((sbyte)(b2 & 240 | value & 15)));
			}
		}
