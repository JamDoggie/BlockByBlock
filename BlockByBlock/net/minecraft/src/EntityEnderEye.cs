		...
		public override void onUpdate()
		{
			...
			if (!this.worldObj.isRemote)
			{
				...
				if (this.despawnTimer > 80 && !this.worldObj.isRemote)
				{
					...
					{
						this.worldObj.playAuxSFX(2003, (int)(long)Math.Round(this.posX, MidpointRounding.AwayFromZero), (int)(long)Math.Round(this.posY, MidpointRounding.AwayFromZero), (int)(long)Math.Round(this.posZ, MidpointRounding.AwayFromZero), 0);
					}
				}
			}
