namespace net.minecraft.src
{
	public class EntityAuraFX : EntityFX
	{
		...
		{
			float f14 = this.rand.NextSingle() * 0.1F + 0.2F;
			this.particleRed = f14;
			this.particleGreen = f14;
			this.particleBlue = f14;
			this.ParticleTextureIndex = 0;
			this.setSize(0.02F, 0.02F);
			this.particleScale *= this.rand.NextSingle() * 0.6F + 0.5F;
			this.motionX *= (double)0.02F;
			this.motionY *= (double)0.02F;
			this.motionZ *= (double)0.02F;
			this.particleMaxAge = (int)(20.0D / (portinghelpers.MathHelper.NextDouble * 0.8D + 0.2D));
			this.noClip = true;
		}
