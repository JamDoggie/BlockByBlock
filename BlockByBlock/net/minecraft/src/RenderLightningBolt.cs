	...
	public class RenderLightningBolt : Render
	{
		public virtual void doRenderLightningBolt(EntityLightningBolt entityLightningBolt1, double d2, double d4, double d6, float f8, float f9)
		{
			...
			for (int i18 = 7; i18 >= 0; --i18)
			{
				d11[i18] = d13;
				d12[i18] = d15;
				d13 += (double)(random17.Next(11) - 5);
				d15 += (double)(random17.Next(11) - 5);
			}
			...
			for (int i45 = 0; i45 < 4; ++i45)
			{
				...
				for (int i19 = 0; i19 < 3; ++i19)
				{
					...
					for (int i26 = i20; i26 >= i21; --i26)
					{
						...
						if (i19 == 0)
						{
							d22 += (double)(random46.Next(11) - 5);
							d24 += (double)(random46.Next(11) - 5);
						}
						else
						{
							d22 += (double)(random46.Next(31) - 15);
							d24 += (double)(random46.Next(31) - 15);
						}
