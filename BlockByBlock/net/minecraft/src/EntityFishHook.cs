...
namespace net.minecraft.src
{
	...
	public class EntityFishHook : Entity
	{
		...
		{
			double d3 = this.boundingBox.AverageEdgeLength * 4.0D;
			d3 *= 64.0D;
			return d1 < d3 * d3;
		}
		...
		public override void onUpdate()
		{
			...
			else
			{
				...
				{
					ItemStack itemStack1 = this.angler.CurrentEquippedItem;
					if (this.angler.isDead || !this.angler.EntityAlive || itemStack1 == null || itemStack1.Item != Item.fishingRod || this.getDistanceSqToEntity(this.angler) > 1024.0D)
					{
						this.setDead();
		...
		public override void writeEntityToNBT(NBTTagCompound nBTTagCompound1)
		{
			...
			nBTTagCompound1.setByte("shake", (sbyte)this.shake);
